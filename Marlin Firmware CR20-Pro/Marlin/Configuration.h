...
#define STRING_CONFIG_H_AUTHOR "(RedstoneMaster01)" // Who made the changes.
...
// Optional SD-print temperature override. Configure it from the Temperature menu.
#define SLICER_TEMP_OVERRIDE_DEFAULT false
#define SLICER_OVERRIDE_HOTEND_TEMP  200
#define SLICER_OVERRIDE_BED_TEMP      60

// First two printed layers use these values, then return to slicer fan control
// and 100% feedrate. Cura ;LAYER:n comments are detected automatically.
#define FIRST_LAYERS_COUNT             2
#define FIRST_LAYERS_SPEED_PERCENT    70
#define FIRST_LAYERS_FAN_SPEED       255
#define BETTER_BED_DEFAULT           true

// Used to estimate filament weight on the finished-print screen. The default
// is the density of PLA in grams per cubic centimeter.
#define FILAMENT_DENSITY_G_CM3      1.24f
