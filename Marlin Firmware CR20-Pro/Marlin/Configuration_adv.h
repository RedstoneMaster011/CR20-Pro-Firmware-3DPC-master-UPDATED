 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 100    // Seconds        Changed to 90 seconds to help prevent false thermal runaway errors (may have to increase to 120)
...
//#define LED_CONTROL_MENU
  ...
  #define SD_FINISHED_RELEASECOMMAND "M84 X0 Y200 Z E" // You might want to keep the Z enabled so your bed stays in place.
