    ...
    // Limit to software endstops, if enabled
      ...
      if (soft_endstops_enabled) switch (axis) {
        case X_AXIS:
            ...
            if (!allow_negative_values) min = soft_endstop[X_AXIS].min;
          #endif
        ...
        case Y_AXIS:
            ...
            if (!allow_negative_values) min = soft_endstop[Y_AXIS].min;
          #endif
        ...
        case Z_AXIS:
            ...
            if (!allow_negative_values) min = soft_endstop[Z_AXIS].min;
          #endif
